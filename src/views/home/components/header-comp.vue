<template>
  <div class="tw-flex tw-items-center tw-justify-between tw-w-full">
    <h2 class="tw-text-xl tw-font-semibold tw-text-ink/dark dark:tw-text-sky/lighter">
      {{ $t('message.HOME_HEADLINE_DAILY') }}
    </h2>
...
<script>
import CalendarModal from '@/modules/calendar/calendar-modal.vue'
